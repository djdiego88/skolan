...
{!! Form::open(['route' => ['users.ad.update', $user], 'method' => 'PUT', 'files' => true]); !!}
	...
	<div class="form-group required row">
		...
		<div class="col-sm-6 col-md-3">
			...
			<small class="form-text text-muted">{{ __('No se puede editar.') }}</small>
		</div>
	</div>
	<div class="form-group required row">
	...
	<div class="form-group required row">
		...
		<div class="col-sm-5 col-md-2">
			{!! Form::select('gender',['m'=>'Masculino', 'f'=>'Femenino'],$user->gender,['class'=>'form-control form-control-sm', 'placeholder'=>'Género', 'required']); !!}
		</div>
	</div>
	<div class="form-group required row">
	...
	<div class="form-group">
		...
		<a href="{{route('users.ad.destroy', $user->id)}}" onclick="return confirm('¿Deseas eliminar a {{$name}}?');" class="btn btn-secondary active btn-sm"><i class="fa fa-times" aria-hidden="true"></i> Eliminar a {{$name}}</a>
	</div>
{!! Form::close(); !!}
@endsection
@section('css')
