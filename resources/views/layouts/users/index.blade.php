		...
		<div class="col-md-4">
			<div class="card text-center">
				<div class="card-body">
					...
					<a href="{{route('users.sa.index')}}" class="btn btn-info"><i class="fas fa-users"></i> {{ __('Ver Usuarios') }}</a>
					<a href="{{route('users.sa.add')}}" class="btn btn-success"><i class="fas fa-user-plus"></i> {{ __('Crear') }}</a>
				</div>
			</div>
		</div>
	@endhasrole
		...
		<div class="col-md-4">
			<div class="card text-center">
				<div class="card-body">
					...
					<a href="{{route('users.ad.index')}}" class="btn btn-info"><i class="fas fa-users"></i> {{ __('Ver Usuarios') }}</a>
					<a href="{{route('users.ad.add')}}" class="btn btn-success"><i class="fas fa-user-plus"></i> {{ __('Crear') }}</a>
				</div>
			</div>
		</div>
	@endhasanyrole
		...
		<div class="col-md-4">
			<div class="card text-center">
				<div class="card-body">
					...
					<a href="#" class="btn btn-info"><i class="fas fa-users"></i> {{ __('Ver Usuarios') }}</a>
					@hasanyrole('superadmin|administrative')
						<a href="#" class="btn btn-success"><i class="fas fa-user-plus"></i> {{ __('Crear') }}</a>
					@endhasanyrole
				</div>
			</div>
		</div>
