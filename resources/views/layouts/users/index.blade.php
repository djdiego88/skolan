			...
			@hasanyrole('superadmin|administrative|coordinator|teacher')
				<div class="col-md-4">
					<div class="card text-center">
						...
						<div class="card-footer bg-transparent d-flex justify-content-between">
							<a href="{{route('users.te.index')}}" class="btn btn-sm btn-outline-primary"><i class="fas fa-users"></i> {{ __('Ver usuarios') }}</a>
							@hasanyrole('superadmin|administrative')
								<a href="{{route('users.te.add')}}" class="btn btn-sm btn-outline-success"><i class="fas fa-user-plus"></i> {{ __('Añadir usuario') }}</a>
							@endhasanyrole
						</div>
					</div>
				</div>
			...
			@hasanyrole('superadmin|administrative|coordinator|teacher')
				<div class="col-md-4">
					<div class="card text-center">
						...
						<div class="card-footer bg-transparent d-flex justify-content-between">
							<a href="{{route('users.st.index')}}" class="btn btn-sm btn-outline-primary"><i class="fas fa-users"></i> {{ __('Ver usuarios') }}</a>
							@hasanyrole('superadmin|administrative')
								<a href="{{route('users.st.add')}}" class="btn btn-sm btn-outline-success"><i class="fas fa-user-plus"></i> {{ __('Añadir usuario') }}</a>
							@endhasanyrole
						</div>
					</div>
				</div>
