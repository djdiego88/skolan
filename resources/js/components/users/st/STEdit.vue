                    ...
                    <form accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <template v-if="step === 2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="neighborhood" id="neighborhood" v-model="student.neighborhood" class="form-control" :class="{'is-invalid': errors.neighborhood}" placeholder="Barrio">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="commune" id="commune" v-model="student.commune" class="form-control" :class="{'is-invalid': errors.commune}" placeholder="Comuna / Localidad">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <multiselect
                                    v-model="student.socioeconomic_level"
                                    :options="[1,2,3,4,5,6]"
                                    :searchable="false"
                                    :show-labels="false"
                                    :allow-empty="false"
                                    ...
                                    @select="selectSocioeconomicLevel"
                            ...
                            <div class="form-group required row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="health_care" id="health_care" v-model="student.health_care" class="form-control" :class="{'is-invalid': errors.health_care}" placeholder="Entidad de Salud" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <vue-editor id="allergies" v-model="student.allergies" :editorToolbar="customToolbar"></vue-editor>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <vue-editor id="diseases" v-model="student.diseases" :editorToolbar="customToolbar"></vue-editor>
                                    <div class="invalid-feedback" v-if="errors.diseases">{{errors.diseases[0]}}</div>
                                </div>
                            </div>
                        </template>
                        <template v-if="step === 3">
                            Aquí va lo de la selección de parientes o acudientes
                        </template>
                    </form>
                </div>
            </div>
...
<script>
    ...
    export default {
        props: ['userInfo', 'studentInfo', 'countries'],
        components: {
            Datepicker
        },
        data(){
        ...
        methods: {
            ...
            selectSocioeconomicLevel(selectedOption) {
                this.student.socioeconomic_level = selectedOption.value;
            },
            selectBloodType(selectedOption) {
                this.student.blood_type = selectedOption.value;
            },
            update() {
                if (!this.submiting) {
                    this.submiting = true;
                    ...
                    Object.keys(_self.student).forEach((prop) => {
                        if (_self.student[prop]) { formdata.append(prop, _self.student[prop]) }
                    });
                    axios.post(route('api.users.st.update', this.user.id), formdata, config)
                    .then(response => {
            ...
            deleteUser() {
                if (!this.submiting) {
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                axios.post(route('api.users.st.destroy', _self.user.id))
                                .then(response => {
                                    this.submiting = false;
