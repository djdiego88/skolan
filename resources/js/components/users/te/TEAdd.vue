                    ...
                    <form accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <template v-if="step === 2">
                            ...
                            <div class="form-group required row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="acronym" id="acronym" v-model="user.acronym" class="form-control" :class="{'is-invalid': errors.acronym}" placeholder="Acrónimo" required>
                            ...
                            <div class="form-group required row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="profession" id="profession" v-model="user.profession" class="form-control" :class="{'is-invalid': errors.profession}" placeholder="Profesión" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <vue-editor id="experience" v-model="user.experience" :editorToolbar="customToolbar"></vue-editor>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <vue-editor id="applied_studies" v-model="user.applied_studies" :editorToolbar="customToolbar"></vue-editor>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="scale" id="scale" v-model="user.scale" class="form-control" :class="{'is-invalid': errors.scale}" placeholder="Escala">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="resolution" id="resolution" v-model="user.resolution" class="form-control" :class="{'is-invalid': errors.resolution}" placeholder="Resolución">
        ...
        methods: {
            ...
            create() {
                if (!this.submiting) {
                    ...
                    _self.user.area = (this.user.area) ? JSON.stringify(this.user.area) : {};
                    ...
                    axios.post(route('api.users.te.store'), formdata, config)
                    .then(response => {
