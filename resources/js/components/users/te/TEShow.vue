            ...
            <div class="col-md-10 col-xl-9">
                <div class="card-header px-0 mt-2 bg-transparent clearfix">
                    ...
                    <div class="card-header-actions mr-1">
                        <a :href="route('users.te.edit', user.id)" class="btn btn-primary" title="Editar usuario"><i class="fas fa-edit"></i><span class="d-md-down-none ml-1">Editar</span></a>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#teacher" role="tab">Docente</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="tab-pane fade" id="teacher" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-10 mb-2">
                                            <h4 class="mb-4"><i class="fas fa-chalkboard-teacher"></i> Información del docente</h4>
                                            <dl class="row">
                                                <dt class="col-3 text-right">Área: </dt>
                                                <dd class="col-9">{{user.teacher.area.name}}</dd>
                                                <template v-if="user.teacher.profession">
                                                    <dt class="col-3 text-right">Profesión: </dt>
                                                    <dd class="col-9">{{user.teacher.profession}}</dd>
                                                </template>
                                                <template v-if="user.teacher.resolution">
                                                    <dt class="col-3 text-right">Resolución: </dt>
                                                    <dd class="col-9">{{user.teacher.resolution}}</dd>
                                                </template>
                                                <template v-if="user.teacher.scale">
                                                    <dt class="col-3 text-right">Escalafón: </dt>
                                                    <dd class="col-9">{{user.teacher.scale}}</dd>
                                                </template>
                                                <template v-if="user.teacher.experience">
                                                    <dt class="col-3 text-right">Experiencia: </dt>
                                                    <dd class="col-9" v-html="user.teacher.experience"></dd>
                                                </template>
                                                <template v-if="user.teacher.applied_studies">
                                                    <dt class="col-3 text-right">Estudios: </dt>
                                                    <dd class="col-9" v-html="user.teacher.applied_studies"></dd>
                                                </template>
                                            </dl>
                                        </div>
                                    </div>
