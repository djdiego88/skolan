...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $coordinator->givePermissionTo([$viewStudent,$viewGuardian,$viewTeacher,$adminSchedule,$addSchedule,$viewSchedule,$editSchedule,$deleteSchedule,$adminEnrollment,$addEnrollment,$viewEnrollment,$editEnrollment,$deleteEnrollment,$adminAbsence,$addAbsence,$viewAbsence,$editAbsence,$deleteAbsence,$adminAnnotation,$addAnnotation,$viewAnnotation,$editAnnotation,$deleteAnnotation,$viewHomework,$viewQualification,$editQualification,$adminTests,$addTests,$viewTests,$editTests,$deleteTests]);
        $teacher->givePermissionTo([$viewStudent,$viewGuardian,$adminAbsence,$addAbsence,$viewAbsence,$editAbsence,$deleteAbsence,$adminAnnotation,$addAnnotation,$viewAnnotation,$editAnnotation,$deleteAnnotation,$addHomework,$viewHomework,$editHomework,$deleteHomework,$addQualification,$viewQualification,$editQualification,$deleteQualification,$addTests,$viewTests,$editTests,$deleteTests]);
